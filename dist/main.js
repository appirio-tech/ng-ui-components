...
$templateCache.put("views/image-viewer-header.directive.html","<main class=\"flex column light-bg\"><div class=\"header flex space-between\"><div class=\"user flex middle\"><a href={{vm.generateProfileUrl(vm.handle)}} target=_blank><avatar avatar-url=\"{{ vm.avatar }}\"></avatar></a><div class=\"titles flex column\"><a href={{vm.generateProfileUrl(vm.handle)}} target=_blank><p class=name>{{ vm.handle }}</p></a><p ng-if=vm.title class=title>{{vm.title}}</p></div></div><div class=icons><button ng-if=vm.downloadAllowed class=clean><a href=\"{{ vm.downloadUrl }}\" target=_blank><div class=\"icon download\"></div></a></button><button ng-click=vm.toggleComments() ng-if=vm.commentsAllowed class=clean><div class=\"icon bubble\"></div></button></div></div><hr></main>");
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.Select = __webpack_require__(109);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classes = __webpack_require__(268);
	var Value = __webpack_require__(269);
	var SingleValue = __webpack_require__(270);
	var Option = __webpack_require__(271);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deprecated = __webpack_require__(265);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(153);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(150);
	var ReactEmptyComponentRegistry = __webpack_require__(152);
	var ReactInstanceHandles = __webpack_require__(153);
	...
	function inject() {
	  ...
	  if (process.env.NODE_ENV !== 'production') {
	    ...
	    if (/[?&]react_perf\b/.test(url)) {
	      var ReactDefaultPerf = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(138);
	var EventPropagators = __webpack_require__(181);
	var SyntheticMouseEvent = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponent = __webpack_require__(231);
	var ReactElement = __webpack_require__(150);
	var ReactPropTypeLocations = __webpack_require__(173);
	var ReactPropTypeLocationNames = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(153);
	var ReactMarkupChecksum = __webpack_require__(156);
	var ReactServerBatchingStrategy = __webpack_require__(258);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapObject = __webpack_require__(263);
