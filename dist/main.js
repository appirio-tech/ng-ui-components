...
$templateCache.put("views/checkbox.directive.html","<button ng-class=\"{\'checked\': ngModel}\" ng-click=\"vm.toggle()\" class=\"clean\"><div class=\"icon checkmark smallest\"></div></button><label ng-if=\"label\" ng-click=\"vm.toggle()\">{{ label }}</label>");
