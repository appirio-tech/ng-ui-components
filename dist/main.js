...
$templateCache.put("views/date-input.directive.html","<div class=\"flex middle\"><input type=\"text\" ng-model=\"date\"/><button class=\"clean\"><div class=\"icon warning\"></div></button></div>");
