...
$templateCache.put("views/checkbox.directive.html","<div class=\"flex center\"><button ng-class=\"{\'checked\': ngModel}\" ng-click=\"vm.toggle()\" type=\"button\" class=\"clean\"><img src=\"/images/icon-plus.svg\" ng-hide=\"ngModel\" class=\"icon plus\"/><img src=\"/images/icon-check-solid.svg\" ng-show=\"ngModel\" class=\"icon check-solid\"/></button><label ng-if=\"label\" ng-click=\"vm.toggle()\">{{ label }}</label></div>");
